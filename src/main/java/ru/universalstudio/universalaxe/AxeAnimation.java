...
import org.bukkit.util.Vector; // данные импорты оставляет т.к есть векторы в жаве и в баккит апи (точн не помню)
...
public class AxeAnimation extends BukkitRunnable {
    ...
    public AxeAnimation(Player shooter, Axe axe, Location loc, Vector vec, int speed) {
        ...
        stand.setMetadata("uaxes-armorstand", new FixedMetadataValue(AxesPlugin.instance(), "i am sexy")); // sexy, sexy, gege))
